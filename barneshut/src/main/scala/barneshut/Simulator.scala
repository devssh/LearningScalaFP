...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries = {
    val nextBoundary = new Boundaries()
    nextBoundary.minX = a.minX min b.minX
    nextBoundary.minY = a.minY min b.minY
    nextBoundary.maxX = a.maxX max b.maxX
    nextBoundary.maxY = a.maxY max b.maxY
    nextBoundary
  }
