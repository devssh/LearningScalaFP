...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(name$1) {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  var discriminant = $uD(this.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a, b, c).apply__O());
  if ((discriminant < 0)) {
    $m_Lcalculator_Signal$();
    ...
    $m_Lcalculator_Signal$();
    var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, discriminant$1) {
      return (function() {
        $m_sci_List$();
        var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([(((-$uD(b$2.apply__O())) + $uD($g.Math.sqrt(discriminant$1))) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) - $uD($g.Math.sqrt(discriminant$1))) / (2 * $uD(a$2.apply__O())))]);
        var this$7 = $m_sci_List$();
        var cbf = this$7.ReusableCBFInstance$2;
        var this$8 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf));
        var this$9 = $m_sci_Set$();
        var cbf$1 = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$9);
        return $as_sci_Set($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$8, cbf$1))
      })
    })(a, b, discriminant));
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var remainingChars = $uI(remainingCharsCount$1.apply__O());
      return ((remainingChars >= 15) ? "green" : ((remainingChars >= 0) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
